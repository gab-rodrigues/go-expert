...
const file_proto_course_category_proto_rawDesc = "" +
	...
	"\bcategory\x18\x01 \x01(\v2\f.pb.CategoryR\bcategory\"D\n" +
	...
	"\x14CreateCategoryStream\x12\x19.pb.CreateCategoryRequest\x1a\x18.pb.CategoryListResponse\"\x00(\x01\x12R\n" +
	"!CreateCategoryStreamBidirectional\x12\x19.pb.CreateCategoryRequest\x1a\f.pb.Category\"\x00(\x010\x01\x127\n" +
	"\x0eListCategories\x12\t.pb.blank\x1a\x18.pb.CategoryListResponse\"\x00\x129\n" +
	"\x0fGetCategoryByID\x12\x16.pb.GetCategoryRequest\x1a\f.pb.Category\"\x00B\rZ\vinternal/pbb\x06proto3"
...
var file_proto_course_category_proto_goTypes = []any{
	...
	(*CategoryListResponse)(nil),  // 5: pb.CategoryListResponse
}
var file_proto_course_category_proto_depIdxs = []int32{
	1, // 0: pb.CategoryResponse.category:type_name -> pb.Category
	1, // 1: pb.CategoryListResponse.categories:type_name -> pb.Category
	...
	3, // 6: pb.CategoryService.GetCategoryByID:input_type -> pb.GetCategoryRequest
	4, // 7: pb.CategoryService.CreateCategory:output_type -> pb.CategoryResponse
	5, // 8: pb.CategoryService.CreateCategoryStream:output_type -> pb.CategoryListResponse
	1, // 9: pb.CategoryService.CreateCategoryStreamBidirectional:output_type -> pb.Category
	5, // 10: pb.CategoryService.ListCategories:output_type -> pb.CategoryListResponse
	1, // 11: pb.CategoryService.GetCategoryByID:output_type -> pb.Category
